...
export class PageTimeSpan extends BasePage {
    ...
    buildLayouts() {
        ...
        this.buildHeader(columnLayout, 'TimeSpan', 'TimeSpan class provides methods to handle time and time intervals.',
            'PageTimeSpan.ts',`${Shared.urlCoreCodes}/TimeSpan.ts`);
